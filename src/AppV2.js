        ...
        <div class="text-center">
          ...
          <div class="text-left mb-8 space-y-3">
            ...
            <div class="flex items-center gap-3">
              ...
              <span class="text-gray-300">Exclusive lessons & patterns</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center">
                <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex items-center gap-3">
              ...
              <span class="text-gray-300">Advanced AI scanner features</span>
            </div>
          </div>
  ...
  useEffect(() => {
    if (Capacitor.isNativePlatform()) {
      const handleBackButton = () => {
        ...
        if (currentLecture || currentCategory) {
...
<div className="bg-gray-800 p-4 flex items-center justify-between">
  <h1 className="text-2xl font-bold">CandleSticks101</h1>
  <div className="flex items-center gap-3">
  {/* Level Display */}
  ...
  >
    ...
    {userProfile.isPremium && (
      ...
      {currentTab === 'lessons' && !currentCategory && (
  <div className="space-y-4">
    {/* Quick Actions Row */}
    ...
    {/* Row 2 - Bullish/Bearish */}
    <div className="grid grid-cols-2 gap-4">
      <button
        onClick={() => setCurrentCategory(sampleLectureData.categories.bullish_patterns)}
        className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 p-8 rounded-xl transition-all shadow-lg"
      >
        <div className="flex flex-col items-center gap-2">
          <TrendingUp className="w-8 h-8" />
          <span className="text-lg font-bold text-center">Bullish</span>
          <span className="text-lg font-bold text-center">Candlesticks</span>
        </div>
      </button>
      
      <button
        onClick={() => setCurrentCategory(sampleLectureData.categories.bearish_patterns)}
        className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 p-8 rounded-xl transition-all shadow-lg"
      >
        <div className="flex flex-col items-center gap-2">
          <TrendingDown className="w-8 h-8" />
          <span className="text-lg font-bold text-center">Bearish</span>
          <span className="text-lg font-bold text-center">Candlesticks</span>
        </div>
      </button>
    </div>

    {/* Row 3 - Technical/Fundamental */}
    <div className="grid grid-cols-2 gap-4">
      <button
        onClick={() => setCurrentCategory(sampleLectureData.categories.technical_indicators)}
        className="bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 p-8 rounded-xl transition-all shadow-lg"
      >
        <div className="flex flex-col items-center gap-2">
          <BarChart3 className="w-8 h-8" />
          <span className="text-lg font-bold text-center">Technical</span>
          <span className="text-lg font-bold text-center">Indicators</span>
        </div>
      </button>
      
      <button
        onClick={() => setCurrentCategory(sampleLectureData.categories.fundamental_analysis)}
        className="bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 p-8 rounded-xl transition-all shadow-lg"
      >
        <div className="flex flex-col items-center gap-2">
          <DollarSign className="w-8 h-8" />
          <span className="text-lg font-bold text-center">Fundamental</span>
          <span className="text-lg font-bold text-center">Analysis</span>
        </div>
      </button>
    </div>
  </div>
    ...
    <div className="p-6 space-y-4">
      {currentCategory.lectures.map((lecture, index) => (
        <button
          ...
          onClick={async () => {
            if (!userProfile.isPremium) {
              await showInterstitialAd(`Opening ${lecture.title} lesson`);
            }
            setCurrentLesson({
              ...lecture,
