...
//usestates
  ...
  const getThemeColors = (colorTheme) => {
    const themes = {
      ...
      "teal-green": {
        // Backgrounds & Containers
        quickSummary: "from-emerald-800 to-emerald-900", 
        quickSummaryBorder: "border-emerald-600",
        expandable: "from-emerald-700 to-emerald-800 hover:from-emerald-600 hover:to-emerald-700",
  ...
  (() => {
    ...
    return (
      <div className="min-h-screen bg-gray-900">
        ...
        <div className={`bg-gradient-to-r ${themeColors.expandable} p-4 flex items-center gap-3 border-b ${themeColors.expandableBorder}`}>
  <button 
    onClick={() => setCurrentLesson(null)}
