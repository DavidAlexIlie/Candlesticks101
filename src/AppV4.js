    ...
    return (
      <div className="bg-gray-800 rounded-lg p-4 border border-gray-600">
        ...
        <svg width={width} height={height} className="mx-auto">
          ...
          <g>
            {(() => {
              const textWidth = stepDescription.length * 7 + 60;
              const containerWidth = Math.max(300, textWidth);
              return (
                <>
                  <rect 
                    x={8} 
  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4 border border-gray-600">
      ...
      <svg width={width} height={height} className="mx-auto">
        ...
        <g>
          {(() => {
            const currentStepText = candlestickData.animationSteps[animationStep];
            const textWidth = currentStepText.length * 7 + 60;
            const containerWidth = Math.max(300, textWidth);
            return (
              <>
                <rect 
                ...
                <text 
                  ...
                  style={{ fontSize: '11px', fontFamily: 'ui-monospace, monospace' }}
                >
                  Step {animationStep + 1}/{candlestickData.animationSteps.length} • {currentStepText}
                </text>
              </>
            );
          })()}
