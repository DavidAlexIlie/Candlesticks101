...
//usestates
  ...
  const getThemeColors = (colorTheme) => {
    const themes = {
      ...
      "teal-green": {
        // Backgrounds & Containers - Using teal colors that should work
        quickSummary: "from-teal-800 to-teal-900", 
        quickSummaryBorder: "border-teal-600",
        expandable: "from-teal-700 to-teal-800 hover:from-teal-600 hover:to-teal-700",
    ...
    // Special fallback for teal-green if Tailwind classes don't work
    if (colorTheme === "teal-green") {
      return {
        ...themes[colorTheme],
        // Add inline style properties as backup
        inlineStyles: {
          quickSummary: { background: 'linear-gradient(to right, #0d5f5f, #0a4a4a)' },
          expandable: { background: 'linear-gradient(to right, #0d7373, #0d5f5f)' },
          header: { color: '#2dd4bf' },
          title: { color: '#5eead4' },
          subtitle: { color: '#99f6e4' }
        }
      };
    }
    
    // Special fallback for rose-pink if Tailwind classes don't work
    if (colorTheme === "rose-pink") {
      return {
        ...themes[colorTheme],
        // Add inline style properties as backup
        inlineStyles: {
          quickSummary: { background: 'linear-gradient(to right, #8b1538, #7c1f2e)' },
          expandable: { background: 'linear-gradient(to right, #9d1c55, #8b1538)' },
          header: { color: '#f472b6' },
          title: { color: '#f9a8d4' },
          subtitle: { color: '#fbb6ce' }
        }
      };
    }
                ...
                {showLowerWick && (
                  <g className="animate-fade-in">
                    <line
                      ...
                      className={(isCurrentCandle && stepInCurrentCandle === 0) ? "animate-pulse" : ""}
                    />
                  </g>
                )}
                ...
                {showBody && (
                  <g className="animate-fade-in">
                    <rect
                      ...
                      strokeWidth={1}
                      rx={2}
                      className={(isCurrentCandle && stepInCurrentCandle === 2) ? "animate-pulse" : ""}
                    />
                  </g>
                )}
              </g>
...
<div className={`bg-gradient-to-r ${themeColors?.expandable || 'from-gray-700 to-gray-800'} rounded-lg p-2 text-center border ${themeColors?.expandableBorder || 'border-gray-500'}`}>
<div className={`text-xs font-medium tracking-wide ${themeColors?.headerColor || 'text-gray-200'}`}>
  Step {animationStep + 1}/{candlestickData.animationSteps?.length || 1} • {candlestickData.animationSteps?.[animationStep] || 'Loading...'}
</div>
  </div>
      ...
      <div className="space-y-4">
        ...
        {content.map((item, index) => {
          ...
          switch (item.type) {
            ...
            return (
              <h1 key={index} 
                  className={themeColors?.inlineStyles ? "text-3xl font-bold mb-6 flex items-center gap-3" : `text-3xl font-bold ${themeColors?.headerColor || 'text-white'} mb-6 flex items-center gap-3`}
                  style={themeColors?.inlineStyles ? themeColors.inlineStyles.header : {}}>
          ...
          case 'h2':
            return (
              <h2 key={index} 
                  className={themeColors?.inlineStyles ? "text-xl font-bold mt-8 mb-4 border-b pb-2" : `text-xl font-bold ${themeColors?.titleColor || 'text-blue-300'} mt-8 mb-4 border-b ${themeColors?.expandableBorder || 'border-blue-600'} pb-2`}
                  style={themeColors?.inlineStyles ? { ...themeColors.inlineStyles.title, borderBottomColor: '#2dd4bf' } : {}}>
                {item.content}
              </h2>
            );
          ...
          case 'h3':
            return (
              <h3 key={index} 
                  className={themeColors?.inlineStyles ? "text-lg font-semibold mt-6 mb-3" : `text-lg font-semibold ${themeColors?.subtitleColor || 'text-blue-200'} mt-6 mb-3`}
                  style={themeColors?.inlineStyles ? themeColors.inlineStyles.title : {}}>
                {item.content}
              </h3>
            );
            ...
            case 'p':
              return (
                <p key={index} 
                   className={themeColors?.inlineStyles ? "leading-relaxed text-base" : `${themeColors?.subtitleColor || 'text-gray-300'} leading-relaxed text-base`}
                   style={themeColors?.inlineStyles ? themeColors.inlineStyles.subtitle : {}}>
                  {item.content}
                </p>
              );
            ...
            case 'tip':
              return (
                <div key={index} className={themeColors?.inlineStyles ? "border-l-4 p-4 rounded-r-lg" : "bg-blue-900 border-l-4 border-blue-400 p-4 rounded-r-lg"}
                     style={themeColors?.inlineStyles ? { backgroundColor: '#0d5f5f', borderLeftColor: '#2dd4bf' } : {}}>
                  <div className="flex items-start gap-2">
                    <Lightbulb className={themeColors?.inlineStyles ? "w-5 h-5 mt-1 flex-shrink-0" : "w-5 h-5 text-blue-400 mt-1 flex-shrink-0"} 
                               style={themeColors?.inlineStyles ? { color: '#2dd4bf' } : {}} />
                    <div>
                      <h4 className={themeColors?.inlineStyles ? "font-bold mb-1" : "font-bold text-blue-300 mb-1"}
                          style={themeColors?.inlineStyles ? { color: '#5eead4' } : {}}>Pro Tip</h4>
                      <p className={themeColors?.inlineStyles ? "" : themeColors?.subtitleColor || 'text-blue-200'}
                         style={themeColors?.inlineStyles ? themeColors.inlineStyles.subtitle : {}}>{item.content}</p>
                    </div>
                  </div>
                </div>
              );
            ...
            case 'quote':
              ...
              case 'expandable':
                ...
                return (
                  <div key={index} className={themeColors?.inlineStyles ? "border-2 rounded-lg overflow-hidden my-4 shadow-lg" : `border-2 ${themeColors?.expandableBorder || 'border-purple-500'} rounded-lg overflow-hidden my-4 shadow-lg`}
                       style={themeColors?.inlineStyles ? { borderColor: '#2dd4bf' } : {}}>
                    <button
                      onClick={(e) => {
                        e.preventDefault();
                        e.stopPropagation();
                      ...
                      className={themeColors?.inlineStyles ? "w-full p-4 transition-all duration-200 flex items-center justify-between text-left transform hover:scale-[1.02]" : `w-full p-4 bg-gradient-to-r ${themeColors?.expandable || 'from-purple-700 to-blue-700'} transition-all duration-200 flex items-center justify-between text-left transform hover:scale-[1.02]`}
                      style={themeColors?.inlineStyles ? themeColors.inlineStyles.expandable : {}}
                    >
                      <span className={themeColors?.inlineStyles ? "font-semibold flex items-center gap-3" : "font-semibold text-white flex items-center gap-3"}
                            style={themeColors?.inlineStyles ? themeColors.inlineStyles.header : {}}>
                        <Eye className={themeColors?.inlineStyles ? "w-5 h-5" : `w-5 h-5 ${themeColors?.iconColor || 'text-purple-300'}`}
                             style={themeColors?.inlineStyles ? { color: '#2dd4bf' } : {}} />
                        <span className="text-lg">{item.title}</span>
                      </span>
                      <div className="flex items-center gap-2">
                        <span className={themeColors?.inlineStyles ? "text-sm" : `${themeColors?.subtitleColor || 'text-purple-200'} text-sm`}
                              style={themeColors?.inlineStyles ? themeColors.inlineStyles.subtitle : {}}>
                          {isExpanded ? 'Hide' : 'Show'}
                        </span>
                        {isExpanded ? (
                          <ChevronUp className={themeColors?.inlineStyles ? "w-6 h-6" : `w-6 h-6 ${themeColors?.iconColor || 'text-purple-200'}`}
                                     style={themeColors?.inlineStyles ? { color: '#2dd4bf' } : {}} />
                        ) : (
                          <ChevronDown className={themeColors?.inlineStyles ? "w-6 h-6" : `w-6 h-6 ${themeColors?.iconColor || 'text-purple-200'}`}
                                       style={themeColors?.inlineStyles ? { color: '#2dd4bf' } : {}} />
                        )}
                      </div>
                    </button>
                    ...
                    {isExpanded && (
                      <div className={themeColors?.inlineStyles ? "p-6 space-y-4 border-t" : "p-6 bg-gray-800 space-y-4 border-t border-purple-400"}
                           style={themeColors?.inlineStyles ? { backgroundColor: '#0a3a3a', borderTopColor: '#2dd4bf' } : {}}>
  ...
  useEffect(() => {
    if (Capacitor.isNativePlatform()) {
      const handleBackButton = () => {
        ...
        // 3. Dacă e vreo secțiune/modal deschis, închide-l
...
setCurrentSection(null);
  ...
  }, [showProfile, currentTab, selectedQuizCategory, selectedFlashcardCategory]);
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <div className="sticky top-0 bg-gray-800 p-4 border-b border-gray-700 z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="w-full bg-gray-700 rounded-full h-2">
            <div 
              className={themeColors?.inlineStyles ? "h-2 rounded-full transition-all duration-300" : `bg-gradient-to-r ${themeColors?.progress || 'from-blue-500 to-blue-600'} h-2 rounded-full transition-all duration-300`}
              style={themeColors?.inlineStyles ? 
                { width: `${Math.max(0, Math.min(100, maxProgress || 0))}%`, background: 'linear-gradient(to right, #2dd4bf, #14b8a6)' } : 
                { width: `${Math.max(0, Math.min(100, maxProgress || 0))}%` }
              }
            />
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto p-6">
       ...
       {tldr && (
         <div 
           className={themeColors.inlineStyles ? 'rounded-xl p-6 mb-8 border border-teal-600' : `bg-gradient-to-r ${themeColors.quickSummary} rounded-xl p-6 mb-8 border ${themeColors.quickSummaryBorder}`}
           style={themeColors.inlineStyles ? themeColors.inlineStyles.quickSummary : {}}
         >
           <div className="flex items-start gap-3">
             <div>
               <h2 
                 className={themeColors.inlineStyles ? 'text-xl font-bold mb-3' : 'text-xl font-bold text-green-300 mb-3'}
                 style={themeColors.inlineStyles ? themeColors.inlineStyles.title : {}}
               >⚡ Quick Summary</h2>
               <p 
                 className={themeColors.inlineStyles ? 'text-lg leading-relaxed' : 'text-green-100 text-lg leading-relaxed'}
                 style={themeColors.inlineStyles ? themeColors.inlineStyles.subtitle : {}}
               >{tldr}</p>
             </div>
           </div>
...
{currentTab === 'lessons' && currentLesson && (
  (() => {
    ...
    return (
      <div className="min-h-screen bg-gray-900">
        ...
        <div 
          className={themeColors.inlineStyles ? 'p-4 flex items-center gap-3 border-b border-teal-500' : `bg-gradient-to-r ${themeColors.expandable} p-4 flex items-center gap-3 border-b ${themeColors.expandableBorder}`}
          style={themeColors.inlineStyles ? themeColors.inlineStyles.expandable : {}}
        >
  <button 
    onClick={() => setCurrentLesson(null)}
  ...
  <h1 
    className={themeColors.inlineStyles ? 'text-xl font-bold' : `text-xl font-bold ${themeColors.headerColor}`}
    style={themeColors.inlineStyles ? themeColors.inlineStyles.header : {}}
  >{currentLesson.title}</h1>
        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="flex items-start gap-3">
            <div>
              <h2 
                className={themeColors.inlineStyles ? 'text-xl font-bold mb-3' : `text-xl font-bold ${themeColors.titleColor} mb-3`}
                style={themeColors.inlineStyles ? themeColors.inlineStyles.title : {}}
              >⚡ Quick Summary</h2>
              <p 
                className={themeColors.inlineStyles ? 'text-lg leading-relaxed' : `${themeColors.subtitleColor} text-lg leading-relaxed`}
                style={themeColors.inlineStyles ? themeColors.inlineStyles.subtitle : {}}
              >{tldr}</p>
            </div>
          </div>
