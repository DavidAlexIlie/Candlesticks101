  ...
  if (isMultiCandle) {
    ...
    return (
      <div className="bg-gray-800 rounded-lg p-4 border border-gray-600">
        ...
        <div className="mb-3">
  <div className={`bg-gradient-to-r ${themeColors.expandable} rounded-lg p-2 text-center border ${themeColors.expandableBorder}`}>
    <div className={`text-xs font-medium tracking-wide ${themeColors.headerColor}`}>
